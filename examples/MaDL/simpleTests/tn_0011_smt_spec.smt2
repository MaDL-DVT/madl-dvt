(set-logic QF_LIA)
(declare-fun Queue_5 () Int) (assert (<= 0 Queue_5)) (assert (<= Queue_5 2))
...
(assert (= block_Queue_2 (and (>= (* 1 Queue_2) 1) (or (and (= 2 (* 1 Queue_4)) (>= (* 1 Queue_3) 1) block_Queue_4) idle_Queue_3))))


(assert (= block_Queue_3 (and (>= (* 1 Queue_3) 1) (or (and (= 2 (* 1 Queue_4)) (>= (* 1 Queue_2) 1) block_Queue_4) idle_Queue_2))))
